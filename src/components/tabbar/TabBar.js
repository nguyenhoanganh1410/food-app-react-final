    ...
    <section class='tab-bar'>
      <div className={`bar_content ${openBar ? 'active_content' : ''}`}>
        <div className='content_top'>
          ...
          {isSignedIn ? (
            <div className='content_top-logout' onClick={() => logout()}>
              Đăng Xuất
            </div>
          ) : (
            <div className='content_top-logout' onClick={() => handleLogin()}>
              Đăng Nhập
            </div>
          )}
        </div>
        ...
        <div className='content_favourite' onClick={() => handleOpenWishList()}>
          <span>
            <FaVoteYea />
          </span>
